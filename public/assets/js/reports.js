...
$(document).ready(function () {
    ...
    $('#itpnow').DataTable({
        ...
        language: {
            ...
            search: "Cari:",
            emptyTable:"<div class='d-flex flex-column align-items-center justify-content-center py-4'><img src='../assets/img/img-data-empty.svg' alt='Data Kosong' style='width: 280px; height: auto; object-fit: contain;' class='mb-3'><h5 class='fw-bold mb-1' style='color: #12161C; font-size: 16px; font-family: sans-serif;'>Data Transaksi Masih Kosong</h5><p class='m-0' style='color: #595C60; font-size: 14px; font-weight: 400;'>Saat ini data rangkuman distribusi belum tersedia </p></div>"
        },
