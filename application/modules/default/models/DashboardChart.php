...
class Default_Model_DashboardChart
{
    /**
     * Konfigurasi layanan
     */
    ...
    /**
     * Build matrix hanya SATU KALI LOOP
     */
    private static function buildMatrix(
         ...
         */
        foreach ($rows as $row) {
            $service = strtoupper(trim($row['LAYANAN']));

            if (!isset(self::SERVICES[$service])) {
                continue;
            }

            $hour = substr($row['JAM'], 11, 2) . ':00';
